---
description: >-
  These are the safer strategies that still encapsulate a directional market
  trade.
---

# Leveraged vanilla yVaults

<figure><img src="../../.gitbook/assets/Screenshot 2022-10-26 at 9.32.54 PM.png" alt=""><figcaption><p><a href="https://app.gearbox.fi/accounts/strategies/list">https://app.gearbox.fi/accounts/strategies/list</a></p></figcaption></figure>
...
The vault uses a large variety of strategies, including lending on Aave and Compound and LPing on Curve and Balancer among a wide variety of other strategies ([see the full list of their strategies)](https://vaults.yearn.finance/ethereum/defi-tokens#0xA696a63cc78DfFa1a63E9E50587C197387FF6C7E).
