...
{% hint style="success" %}
About 4% a year from the supply (DAO portion holding > 40%) goes into different initiatives and liquidity mining. The goal is to bring that number down as much as possible.
